            ...
            <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-2 gap-8 technology-top technology-top">
              <div className="technology-content-container mt-20">
                ...
                <p className="mt-2 leading-relaxed">
                  ...
                  the best solutions tailored to your industry and needs. Let us
                  help you achieve your digital goals. Reach out to us now for a
                  consultation and take the first step towards a powerful online
                  presence.
                </p>
              </div>
