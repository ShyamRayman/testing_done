                  ...
                  <div className="w-full flex flex-col items-center relative">
                    ...
                    <div className="flex justify-center relative z-10 lg:top-16 lg:right-8 md:right-8 md:bottom-8 sm:right-8 sm:bottom-8 Kindimgpos">
                      <img
                        ...
                        alt="Kind-img"
                        className="w-full max-w-[400px] sm:max-w-[500px] md:max-w-[500px] lg:max-w-[500px] xl:max-w-[600px] object-contain Kindimg relative xl:top-20 xl:right-3 lg:top-12 lg:right-3"
                      />
                    </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center z-0">
                      <section className="overflow-visible">
                        <div className="relative lg:top-24">
                          <div className="circle-text flex items-center justify-center text-rotate-container lg:mt-24 xl:mt-36 ">
                            <svg
